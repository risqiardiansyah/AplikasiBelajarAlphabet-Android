...
public class Uu extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Button next = (Button) findViewById(R.id.buttonNextOnU);
        next.setOnClickListener(new View.OnClickListener() {
			
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent flsh = new Intent(arg0.getContext(), Vv.class);
				startActivityForResult(flsh, 0);
			}
		});
        
        Button prev = (Button) findViewById(R.id.buttonSblmOnU);
        prev.setOnClickListener(new View.OnClickListener() {
			
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent flsh = new Intent(arg0.getContext(), Tt.class);
				startActivityForResult(flsh, 0);
			}
		});
